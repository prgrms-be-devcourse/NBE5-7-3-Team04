...
public interface ManagerPerformanceApiDocs {
    ...
    ResponseEntity<Page<PerformanceManagerPageResponse>> getPerformances(
    ...
    ResponseEntity<PerformanceManagerDetailResponse> getPerformanceDetails(
    ...
    ResponseEntity<Long> registerPerformance(
        @Parameter(description = "공연 등록 정보", required = true) PerformanceCreateRequest request,
        @Parameter(description = "인증된 사용자 정보") @AuthenticationPrincipal CustomOAuth2User principal
    );
    ...
    ResponseEntity<Long> registerPerformanceSchedule(
        @Parameter(description = "공연 ID", required = true) Long performanceId,
        @Parameter(description = "일정 등록 정보", required = true) PerformanceScheduleRequest request,
        @Parameter(description = "인증된 사용자 정보") @AuthenticationPrincipal CustomOAuth2User principal
    );
    ...
    ResponseEntity<Void> updatePerformance(
        @Parameter(description = "공연 ID", required = true) Long performanceId,
        @Parameter(description = "공연 수정 정보", required = true) PerformanceUpdateRequest request,
        @Parameter(description = "인증된 사용자 정보") @AuthenticationPrincipal CustomOAuth2User principal
    );
    ...
    ResponseEntity<Void> cancelPerformance(
        @Parameter(description = "공연 ID", required = true) Long performanceId,
        @Parameter(description = "인증된 사용자 정보") @AuthenticationPrincipal CustomOAuth2User principal
    );
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "404", description = "공연 또는 일정을 찾을 수 없음 (PERFORMANCE_NOT_FOUND, PERFORMANCE_SCHEDULE_NOT_FOUND)",
            content = @Content(schema = @Schema(implementation = ErrorResponse.class))
        )
    })
    ResponseEntity<Void> cancelPerformanceSchedule(
        @Parameter(description = "공연 ID", required = true) Long performanceId,
        @Parameter(description = "일정 ID", required = true) Long performanceScheduleId,
        @Parameter(description = "인증된 사용자 정보") @AuthenticationPrincipal CustomOAuth2User principal
    );
    ...
    @PageableAsQueryParam
    ResponseEntity<Page<PerformanceManagerPageResponse>> searchPerformances(
        ...
        @Parameter(description = "공연 상태") PerformanceStatus status,
        @ParameterObject Pageable pageable,
        @Parameter(description = "인증된 사용자 정보") @AuthenticationPrincipal CustomOAuth2User principal
    );
} 