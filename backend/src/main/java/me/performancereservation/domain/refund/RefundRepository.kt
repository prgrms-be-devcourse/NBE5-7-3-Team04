...
interface RefundRepository : JpaRepository<Refund, Long> {
    ...
    fun updateRefundStatus(@Param("id") id: Long?, @Param("status") status: RefundStatus?): Int
    ...
    fun findRefundsDetailByUserId(@Param("userId") userId: Long?, pageable: Pageable?): Page<Array<Any?>?>?
    ...
    fun findRefundsDetailByRefundId(@Param("refundId") refundId: Long?): List<Array<Any?>?>?
    ...
    fun findRefundsDetailByStatus(@Param("status") status: RefundStatus?, pageable: Pageable?): Page<Array<Any?>?>?
    ...
    fun findRefundByReservationIdIn(@Param("reservationIds") reservationIds: List<Long?>?): List<Long?>?
