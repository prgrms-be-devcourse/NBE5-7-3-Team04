...
interface PerformanceRepository : JpaRepository<Performance, Long> {
    fun findByManagerId(managerId: Long, pageable: Pageable): Page<Performance>
    ...
    """)
    fun findAvailablePerformances(pageable: Pageable): Page<Performance>
    ...
    fun searchAvailablePerformances(
        ...
        @Param("category") category: PerformanceCategory?,
        pageable: Pageable
    ): Page<Performance>
    ...
    fun searchManagerPerformances(
        ...
        @Param("status") status: PerformanceStatus?,
        @Param("title") title: String?,
        @Param("venue") venue: String?,
        @Param("start") start: LocalDateTime?,
        @Param("end") end: LocalDateTime?,
    ...
    fun findByEndDateBeforeAndStatus(endDate: LocalDateTime, status: PerformanceStatus): List<Performance>
}
