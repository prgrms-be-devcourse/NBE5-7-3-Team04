...
export function CancelReservationDialog({ reservationId }: CancelReservationDialogProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            예매를 취소하시겠습니까? 환불 정책에 따라 일부 금액만 환불될 수 있습니다.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 py-4">
            <div className="flex items-center gap-2 rounded-md bg-amber-50 p-3 text-amber-600">
              ...
              <span className="text-xs">환불받을 계좌 정보를 입력해주세요.</span>
            </div>
