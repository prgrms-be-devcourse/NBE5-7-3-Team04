...
import { MapPin, Users, ArrowLeft, Loader2, Star, MessageCircle, Calendar, Clock, Heart } from "lucide-react"
...
export default function PerformanceDetailClient({ performanceId }: { performanceId: string }) {
  ...
  const handleBookmark = async () => {
    ...
    try {
      ...
      toast({
        title: isBookmarked ? "찜 목록에서 제거되었습니다." : "찜 목록에 추가되었습니다.",
        description: isBookmarked ? "찜 목록에서 제거되었습니다." : "찜 목록에 추가되었습니다.",
        duration: 2000,
      })
    } catch (error) {
              ...
              <div className="flex-1 min-w-0">
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <h2 className="text-2xl font-bold">{performance.title}</h2>
                      <div className="flex items-center gap-2 mt-2">
                        <Badge variant={getStatusVariant(performance.status)}>
                    ...
                    <CardContent className="pt-6">
                      <div className="space-y-4">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div className="text-sm font-medium">공연 기간</div>
                            <div className="text-sm text-muted-foreground">
                              {formatTimeToKST(performance.startDate)} ~ {formatTimeToKST(performance.endDate)}
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div className="text-sm font-medium">러닝타임</div>
                            <div className="text-sm text-muted-foreground">
                              {performance.schedules[0] && calculateRunningTime(
                                performance.schedules[0].startTime,
                                performance.schedules[0].endTime
                              )}
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div className="text-sm font-medium">공연장</div>
              ...
              <TabsContent value="info" className="mt-4 space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-2 text-muted-foreground">
                    <p>시작일: {formatTimeToKST(performance.startDate)}</p>
                    <p>종료일: {formatTimeToKST(performance.endDate)}</p>
                  </div>
                </div>
                <Separator />
                <div>
                  <h3 className="text-lg font-semibold">회차 정보</h3>
                      ...
                      <div key={schedule.id} className="flex items-center justify-between p-2 bg-gray-50 rounded">
                        <div>
                          <p className="font-medium">
                            {formatTimeToKST(schedule.startTime)}
                          </p>
                  ...
                  <div>
                    ...
                    <div className="border rounded-lg p-4">
                      <CustomCalendar
                        ...
                        availableDates={performance.schedules.map(schedule => parseISO(schedule.startTime))}
                        className="mx-auto"
                      />
